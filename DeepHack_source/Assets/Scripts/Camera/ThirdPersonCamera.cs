...
public class ThirdPersonCamera : MonoBehaviour
{
    ...
    public Vector3 camOffset = new Vector3(0f, 0f, -4.0f);              // Offset to relocate the camera related to the player position.
    ...
    void FixedUpdate()
    {
        ...
        if (Input.GetAxis("Mouse ScrollWheel") != 0)
        {
            ...
            zOffset += Input.GetAxis("Mouse ScrollWheel") * speed;
        }
